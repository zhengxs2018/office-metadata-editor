...
fn run_compare_baseline() {
    ...
    let result =
        tauri_native_lib::documents::compare::run_compare(&[doc], &CompareOptions::default());
...
fn run_compare_findings() {
    ...
    b.creator = "张三".into();
    let result =
        tauri_native_lib::documents::compare::run_compare(&[a, b], &CompareOptions::default());
...
fn run_compare_stats() {
    ...
    let result =
        tauri_native_lib::documents::compare::run_compare(&docs, &CompareOptions::default());
