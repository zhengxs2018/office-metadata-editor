...
export const BatchPage: React.FC = () => {
  ...
  const isBusy = !!batchTaskRequestId || documents.some(doc => !!documentTaskRequestIds[doc.id]);
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          {hasFiles ? (
            <>
              ...
              <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border border-border/60 bg-card">
                    ...
                    <tbody>
                      {filteredRows.length > 0 ? (
                        ...
                        <tr>
                          <td
                            colSpan={9}
                            className="py-12 text-center text-fine-print text-muted-foreground"
                          >
                ...
                <div className="flex shrink-0 items-center justify-between border-t-2 border-border bg-muted/80 px-3 py-1.5 text-fine-print text-muted-foreground">
                  ...
                  <div>{cleanupResult ? <CleanupResultPill result={cleanupResult} /> : null}</div>
                </div>
              </div>
            </>
          ) : (
            ...
            <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-4">
              <FileDropZone onFilesSelected={handleDropZoneFiles} className="w-full max-w-lg" />
