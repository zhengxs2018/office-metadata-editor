...
export const MetadataProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  const createRequest = useCallback(
    async (filePaths: string[], source: string) =>
      invoke<string>('create_automation_request', { filePaths, source }),
    [],
  );
  ...
  const setMetadata = useCallback(
    (newMetadata: DocumentMetadata) => {
      ...
      setDocumentsById(prev => {
        ...
        return {
          ...prev,
          [activeDocumentId]: { ...target, metadata: newMetadata, hasChanges: true },
        };
      });
    },
    [activeDocumentId],
  ...
  const updateField = useCallback(
    (category: MetadataSection['category'], field: string, value: string | number) => {
      ...
      setDocumentsById(prev => {
        ...
        const nextMetadata = applyMetadataFieldUpdate(
          fileType,
          target.metadata,
          category,
          field,
        ...
        return {
          ...prev,
          [activeDocumentId]: { ...target, metadata: nextMetadata, hasChanges: true },
        };
      });
    },
    [activeDocumentId],
  ...
  const resetToOriginal = useCallback(() => {
    ...
    setDocumentsById(prev => {
      ...
      return {
        ...prev,
        [activeDocumentId]: { ...target, metadata: target.originalMetadata, hasChanges: false },
      };
    });
  }, [activeDocumentId]);
